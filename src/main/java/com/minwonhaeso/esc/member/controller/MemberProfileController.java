...
public class MemberProfileController {
    ...
    public ResponseEntity<Map<String, String>> changePasswordMail(@RequestBody Map<String, String> body) {
    ...
    public ResponseEntity<Map<String, String>> changePasswordMailAuth(@RequestBody Map<String, String> response) {
    ...
    public ResponseEntity<Map<String, String>> changePassword(@RequestBody CPasswordDto.Request request) {
